...
object MonkeyCColors {
    ...
    val CLASS_REFERENCE = key("MONKEYC_CLASS_REFERENCE", Default.CLASS_REFERENCE)
    val FUNCTION_DECLARATION = key("MONKEYC_FUNCTION_DECLARATION", Default.FUNCTION_DECLARATION)
    val FUNCTION_CALL = key("MONKEYC_FUNCTION_CALL", Default.FUNCTION_CALL)
    val CONSTANT = key("MONKEYC_CONSTANT", Default.CONSTANT)
